...
public class SignupTotFragment extends Fragment {
    ...
    View signupOne, signupTwo;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.total_signup, container, false);
        signupOne = root.findViewById(R.id.signup_one);
        signupTwo = root.findViewById(R.id.signup_two);
        showOne();
        return root;
    }
    ...
    public void showOne() {
        ...
        signupTwo.setVisibility(View.GONE);
    }

    public void showTwo() {
        signupOne.setVisibility(View.GONE);
        signupTwo.setVisibility(View.VISIBLE);
    }
